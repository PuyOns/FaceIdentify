...
QT_MOC_LITERAL(1, 9, 9), // "sendReast"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 3) // "val"

    },
    "MyThread\0sendReast\0\0val"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendReast((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::sendReast)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::sendReast(bool _t1)
{
