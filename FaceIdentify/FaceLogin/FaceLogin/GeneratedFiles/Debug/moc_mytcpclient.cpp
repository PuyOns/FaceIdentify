...
QT_MOC_LITERAL(1, 12, 18), // "connectFailToSever"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 11) // "readMessage"

    },
    "myTcpClient\0connectFailToSever\0\0"
    "readMessage"
};
...
void myTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectFailToSever(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myTcpClient::connectFailToSever)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myTcpClient::connectFailToSever()
{
